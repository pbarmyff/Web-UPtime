...
export async function runChecks() {
    try {
        ...
        // Performance optimization: Process monitors concurrently in batches
        // This prevents network wait times in checkMonitor from blocking other monitors
        const BATCH_SIZE = 10;
        for (let i = 0; i < monitors.length; i += BATCH_SIZE) {
            ...
            // Explicitly log any rejected promises to prevent swallowed errors
