...
export async function runChecks() {
    try {
        ...
        // Process monitors in batches to improve performance and prevent interval pile-ups
        const BATCH_SIZE = 10;
        for (let i = 0; i < monitors.length; i += BATCH_SIZE) {
            ...
            // Explicitly handle rejected promises to prevent silently swallowed errors
