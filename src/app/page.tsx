          ...
          <div className="flex justify-between items-center h-20">
            ...
            <div className="md:hidden flex items-center">
              <button
                ...
                className="text-[#EDF2FF] hover:text-[#4FFFB0] transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#4FFFB0] rounded-sm p-1"
          ...
          >
            <div className="flex justify-between items-center mb-12">
              ...
              <button
                ...
                className="text-[#EDF2FF] hover:text-[#4FFFB0] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#4FFFB0] rounded-sm p-1"
