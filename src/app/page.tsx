        ...
        <div className="max-w-[1400px] mx-auto px-6 sm:px-12 lg:px-16">
          <div className="flex justify-between items-center h-20">
            ...
            <div className="md:hidden flex items-center">
              <button onClick={() => setIsMobileMenuOpen(true)} className="text-[#EDF2FF] hover:text-[#4FFFB0] transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#4FFFB0] rounded" aria-expanded={isMobileMenuOpen} aria-label="Open menu">
        ...
        {isMobileMenuOpen && (
          ...
          >
            <div className="flex justify-between items-center mb-12">
              ...
              <button onClick={() => setIsMobileMenuOpen(false)} className="text-[#EDF2FF] hover:text-[#4FFFB0] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#4FFFB0] rounded" aria-expanded={isMobileMenuOpen} aria-label="Close menu">
