                    ...
                    {monitors.map(monitor => (
                        <tr key={monitor.id} className="hover:bg-brand-background">
                            <td className="p-4">
                                ...
                                <p className="text-xs text-brand-muted truncate max-w-[200px] sm:max-w-[300px] md:max-w-md lg:max-w-lg">{monitor.url}</p> {/* Responsive fix: Expand URL truncation on larger screens */}
                            </td>
                            <td className="p-4">
