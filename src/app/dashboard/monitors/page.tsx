                    ...
                    {monitors.map(monitor => (
                        <tr key={monitor.id} className="hover:bg-brand-background">
                            <td className="p-4">
                                ...
                                {/* Responsive fix: Increased max-w on larger screens to avoid unnecessary truncation */}
                                <p className="text-xs text-brand-muted truncate max-w-[200px] sm:max-w-[300px] md:max-w-md">{monitor.url}</p>
                            </td>
                            <td className="p-4">
