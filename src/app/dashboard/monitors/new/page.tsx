        ...
        <div className="max-w-2xl mx-auto">
            ...
            <div className="bg-brand-surface p-6 rounded-none  border border-brand-muted/30">
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4"> {/* Responsive fix: changed grid-cols-2 to grid-cols-1 sm:grid-cols-2 to prevent inputs from squishing on mobile devices */}
                        <div>
