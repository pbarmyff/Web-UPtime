...
export default async function DashboardPage() {
  ...
  return (
    <div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">{/* Responsive fix: Changed md:grid-cols-4 to sm:grid-cols-2 lg:grid-cols-4 to prevent cramped columns on tablets when the sidebar appears */}
