...
export default async function AdminDashboard() {
  ...
  return (
    <div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-3 gap-6 mb-8">{/* Responsive fix: Changed md:grid-cols-3 to sm:grid-cols-2 xl:grid-cols-3 to prevent cramped columns on tablets when the sidebar appears */}
